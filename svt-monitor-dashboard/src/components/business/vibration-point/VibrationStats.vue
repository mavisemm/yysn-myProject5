    ...
    <div class="card-item stats-card">
        ...
        <div class="stats-grid">
            <div class="stat-box">
                ...
                <div class="stat-axes">
                    <div class="axis-row"><span class="axis-name">x轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.xvelocityRms) }}</span></div>
                    <div class="axis-row"><span class="axis-name">y轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.yvelocityRms) }}</span></div>
                    <div class="axis-row"><span class="axis-name">z轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.zvelocityRms) }}</span></div>
                </div>
            </div>
            <div class="stat-box">
                <div class="stat-label">
                ...
                <div class="stat-axes">
                    <div class="axis-row"><span class="axis-name">x轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.xvelocityMax) }}</span></div>
                    <div class="axis-row"><span class="axis-name">y轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.yvelocityMax) }}</span></div>
                    <div class="axis-row"><span class="axis-name">z轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.zvelocityMax) }}</span></div>
                </div>
            </div>
            <div class="stat-box">
                <div class="stat-label">
                ...
                <div class="stat-axes">
                    <div class="axis-row"><span class="axis-name">x轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.xaccelerationRms) }}</span></div>
                    <div class="axis-row"><span class="axis-name">y轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.yaccelerationRms) }}</span></div>
                    <div class="axis-row"><span class="axis-name">z轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.zaccelerationRms) }}</span></div>
                </div>
            </div>
            <div class="stat-box">
                <div class="stat-label">
                ...
                <div class="stat-axes">
                    <div class="axis-row"><span class="axis-name">x轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.xaccelerationMax) }}</span></div>
                    <div class="axis-row"><span class="axis-name">y轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.yaccelerationMax) }}</span></div>
                    <div class="axis-row"><span class="axis-name">z轴：</span><span class="stat-value">{{
                        formatValue(vibrationData.zaccelerationMax) }}</span></div>
                </div>
            </div>
        </div>
    </div>
